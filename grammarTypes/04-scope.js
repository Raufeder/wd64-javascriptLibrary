...
What is scope?
    ...
    -scope is how a computer keeps track of all the varia bles in a program
    -scope can also be nested, where there's an puter scope (global) tnhat encloses an inner scope
*/

let scope = 'Earth'; // this is currently in hte global scope of our JS file
...
//! ORDER MATTERS
// JS reads from top to  bottom and acts accordingly to what is being asked. JS is known as a single-threaded language which means it can only execute a single task at a time
