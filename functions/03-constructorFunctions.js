...
/*
    ...
    4. The 'this' keyword. 'this' gives us the ability to refer back to whatever called, or whatever activates it. this case, 'this' refers to 'person'
    5. This will be a key of the pobject we will create. This is NOT refering to the parameter
    6. This is refering to the parameter we pass through our constructor function
    7 & 8. This 'new' keyword is calling upon our person function, creating a new person with the values we passing as arguments, and storing that person in a variable
*/